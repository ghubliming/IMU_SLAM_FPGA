...
int Optimizer::PoseInertialOptimizationLastKeyFrame(Frame *pFrame, bool bRecInit)
{
    ...
    //b的值未在下面更新
     Vector6d old_b;
    old_b << VG->estimate(), VA->estimate();
    //std::cout << "old key   b[3]4  " << old_b[3] << std::endl;
    ...
    Vector6d b;
    b << VG->estimate(), VA->estimate();
    //观察输出发现预积分中的b的值和这里的值一样
    //此处更新了偏置
    pFrame->mImuBias = IMU::Bias(b[3],b[4],b[5],b[0],b[1],b[2]);
    //std::cout << "new key   b[3]4 " << b[3] << std::endl;
...
/*有变化，old等于这帧的dax,new有更新但不等于下帧的dax
    Vector6d old_b;
    old_b << VG->estimate(), VA->estimate();
    std::cout << "old   b[3]4  " << old_b[3] << std::endl;*/
    ...
    //std::cout << "new   b[3]4 " << b[3] << std::endl;
